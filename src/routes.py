...
@consegne_bp.route("/riders/<vehicle>")
...
@consegne_bp.route("/reviews", methods=["POST"])
def post_review():
    try:
...
@consegne_bp.route("/reviews/<int:id>", methods=["PUT"])
...
@consegne_bp.route("/riders/<int:id>", methods=["DELETE"])
def delete_rider(id):
    try:
...
@consegne_bp.route("/media/<int:rider_id>", methods=["GET"])
def media(rider_id):
    try:
